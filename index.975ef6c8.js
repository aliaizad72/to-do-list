...
function createTodo(event) {
    ...
    const newTodo = new (0, _todoDefault.default)(document.getElementById("title").value, document.getElementById("description").value, document.getElementById("duedate").value, document.getElementById("priority").value);
...
function setDefaultProject() {
    projects.push(new (0, _projectDefault.default)("Project 0"));
}
...
function createProject(event) {
    event.preventDefault();
    const newProject = new (0, _projectDefault.default)(document.getElementById("project-name").value);
...
function setDefaultTodo(project) {
    const newTodo = new (0, _todoDefault.default)("Title", "Description", "Mon Oct 14 2024 18:54:23 GMT+0800 (Malaysia Time)", "1");
...
function deserializeProjects(string) {
    ...
    return projects.map((project)=>(0, _projectDefault.default).deserialize(project));
}
function saveProjects() {
    localStorage.setItem("projects", serializeProjects());
}
function setProjects() {
    projects = localStorage.getItem("projects") ? deserializeProjects(localStorage.getItem("projects")) : [];
}
...
},{"./todo":"4wXiY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./project":"8ulW8"}],"4wXiY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"8ulW8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Project {
    static id = 0;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["farZc","8lqZg"], "8lqZg", "parcelRequiree5c7")
